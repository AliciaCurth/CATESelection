...
class _BaseTEScorer:
    ...
    def __call__(self, estimator, X, y_factual, w_factual, p_true=None, t_true=None,
        ...
        """
        return self._score(estimator, X, y_factual, w_factual, p_true, t_true,
                           sample_weight=sample_weight, t_score=t_score)
